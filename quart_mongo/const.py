...
MONGO_URI_ERROR = "You must specify a URI or set the MONGO_URI Quart config variable."
...
ODMANTIC_MODEL_APP = "There are no Odmantic Models registered with the application."
